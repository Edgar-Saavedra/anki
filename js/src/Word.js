...
export class Word extends React.Component {
  ...
  renderTemplate() {
    ...
    return <div className="translation">
      ...
      } dangerouslySetInnerHTML={{ __html: this.props.element.definition.word ? this.props.element.definition.word : (this.props.element.word ? this.props.element.word : null) }}></h2>
