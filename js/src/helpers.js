...
// fetch('/german-conjugations-verbix.json',myInit)
// .then(function(response) {
//   var contentType = response.headers.get("content-type");
//   if(contentType && contentType.indexOf("application/json") !== -1) {
//     return response.json();
...
export const addAnkiCards = (type, data) => {
...
export const createGermanConjugatedNotes = (conjugationGermanData = null) => {
    const notes = [];
...
export const createFrenchConjugatedNotes = (conjugationFrenchData = null) => {
    const notes = [];
